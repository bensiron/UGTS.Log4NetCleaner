...
namespace UGTS.Log4NetCleaner.FunctionalTest
{
    [TestFixture]
    public class SelfCleaningRollingFileAppenderTests
    {
        ...
        public void Setup()
        {
            _testLogPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "temp\\Log4NetCleaner");
            ResetLogging();
            DeleteFiles();
        ...
        {
            SetAppender(() => new SelfCleaningRollingFileAppender { Cleaner = new LogCleaner { MaxFileAgeDays = 1 }});
        ...
        public void Cleans_Up_Old_Files()
        {
            ...
            SetAppender(() => new SelfCleaningRollingFileAppender
            {
                ...
                Cleaner = new LogCleaner { MaxFileAgeDays = 1.5 },
        ...
        public void Backup_Files_Also_Get_Cleaned(int countDirection)
        {
            var appender = SetAppender(() => new SelfCleaningRollingFileAppender
            {
                ...
                Cleaner = new LogCleaner { MaxDirectorySize = 15000 },
        ...
        public void Does_Not_Clean_If_Not_Due_For_Cleaning_Check()
        {
            ...
            {
                RollingStyle = RollingFileAppender.RollingMode.Date,
                Cleaner = new LogCleaner { MaxFileAgeDays = 1.5, PeriodMinutes = 20 },
                DatePattern = "dd_MM_yyyy'.txt'"
            });
        ...
        public void Cleans_After_Period_Expires()
        {
            ...
            {
                RollingStyle = RollingFileAppender.RollingMode.Date,
                Cleaner = new LogCleaner { MaxFileAgeDays = 1.5, PeriodMinutes = period },
                DatePattern = "dd_MM_yyyy'.txt'"
            });
        ...
        public void Cleans_Old_Files_Until_Under_Size_Limit()
        {
            ...
            {
                RollingStyle = RollingFileAppender.RollingMode.Date,
                Cleaner = new LogCleaner { MaxDirectorySize = 12000 },
                DatePattern = "dd_MM_yyyy'.txt'"
            });
        ...
        public void Ignores_Files_With_Wrong_Extension(string extension)
        {
            ...
            {
                RollingStyle = RollingFileAppender.RollingMode.Date,
                Cleaner = new LogCleaner { MaxFileAgeDays = 0.5, FileExtension = extension },
                DatePattern = "dd_MM_yyyy'.txt'"
            });
